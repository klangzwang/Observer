...
#include "OBSystemStatics.generated.h"
...
UCLASS()
class UOBSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Observer", meta = (WorldContext = "WorldContextObject"))
	...
	static void SetRenderCustomDepthOnAllMeshComponents(AActor* TargetActor, const FName ComponentTag, bool bActive);
