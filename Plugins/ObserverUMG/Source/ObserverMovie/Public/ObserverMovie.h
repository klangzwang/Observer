#ifndef __ObserverMovie_H__
#define __ObserverMovie_H__
...
class IObserverMovieModule : public IModuleInterface
{
public:
	...
	DECLARE_EVENT_OneParam(IObserverMovieModule, FOnClipFinished, const FString&)
