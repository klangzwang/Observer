...
#include "OBUILoadingSubsystem.generated.h"
...
UCLASS(MinimalAPI)
class UOBUILoadingSubsystem : public UGameInstanceSubsystem, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	...
	void RegisterLoadingProcessor(TScriptInterface<IOBLoadingProcess> Interface);
	void UnregisterLoadingProcessor(TScriptInterface<IOBLoadingProcess> Interface);
...
private:
	...
	TArray<TWeakInterfacePtr<IOBLoadingProcess>> ExternalLoadingProcessors;
